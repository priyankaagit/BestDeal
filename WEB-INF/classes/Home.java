...
public class Home extends HttpServlet {
    ...
    public void init() {
				 ...
				 lap = new HashMap<String, Product>();
     ...
     // RequestDispatcher view = request.getRequestDispatcher("header.html");
      //         view.forward(request, response);  
			...
			String usertype = (String)session.getValue("usertype");
				...
				String filepath1 = "C:/apache-tomcat-7.0.34/webapps/bestdeal/WEB-INF/classes/Mobile.xml";
				String filepath2 = "C:/apache-tomcat-7.0.34/webapps/bestdeal/WEB-INF/classes/Tablet.xml";
				String filepath3 = "C:/apache-tomcat-7.0.34/webapps/bestdeal/WEB-INF/classes/Television.xml";
...
//			License: Creative Commons Attribution
			...
			"<div id=\"body\">\n" +
				...
				"	<article>\n" +
						...
						"<h2>Welcome to Best Deal</h2> \n" +
				

						"<p>We provide best deal in market.Look no where !!!. </p>	\n" );
						DealMatches dm = new DealMatches();
						HashMap<String, Product> product = dm.selectProductDeal();	
						ArrayList lines = dm.getLines();
						if (lines.isEmpty()){
			...
			"<h3>Hot Deals</h3> \n" );
							...
							if (product.isEmpty()){
								out.println("No Deals Found");
							}
							else{
							for (String productid: product.keySet()) {	
							Product lp = product.get(productid);
