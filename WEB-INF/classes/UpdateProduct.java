                         ...
                         out.println("<li class=\"end\"><a>cart</li>\n" +
							 ...
							 "	<section id=\"content\"> \n");
									...
									if (producttype.equals("Laptop")){
									  lapSession.put(productid,prod);	
									  s.updateProduct(prod,producttype)	;
									} else if (producttype.equals("Mobile")){
										mobSession.put(productid,prod);
										s.updateProduct(prod,producttype)	;
									} else if (producttype.equals("Tablet")){
										tabSession.put(productid,prod);
										s.updateProduct(prod,producttype)	;
									} else if (producttype.equals("Television")){
										tvSession.put(productid,prod);
										s.updateProduct(prod,producttype)	;
									}
											
							out.println("<p>Product has been updated</p>");
