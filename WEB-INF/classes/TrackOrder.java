		...
		String usertype = (String)session.getValue("usertype");			
				...
				out.println("<li class=\"text\">\n" +
                         ...
                         out.println("<li class=\"end\"><a>cart</li>\n" +
							 ...
							 "	<section id=\"content\"> \n");
							 co = s.trackOrder(user);
							
							 for (String orderid: co.keySet()) {
								 
										CustomerOrder c = co.get(orderid);								 
										...
										for(OrderItem i: or){
										    ...
										    out.println("</td> \n");
										    out.println( "<td>\n ");
										    out.println(i.getProductPrice());
										    out.println("</td> \n");
										    out.println("</tr>");
										} 
								 
								 
								           java.util.Date deliverydate = c.getDeliveryDate();
										   out.println("</TABLE>\n" +
										   "<FORM ACTION=\"/bestdeal/CancelOrder\">\n" +
										   "<BIG><CENTER>\n" +
